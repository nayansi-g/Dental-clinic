...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-[#eef2f7] px-4 sm:px-6 md:px-8 lg:px-10 ">
      ...
      <div className="site-shell relative grid min-h-[100svh] grid-cols-1 items-center gap-6 pt-16 sm:pt-20 md:pt-14 lg:min-h-[760px] lg:grid-cols-[minmax(0,1fr)_minmax(340px,600px)] lg:pt-0">
        <div className="max-w-[640px] pb-2 lg:pb-10">
          ...
          <h1 className="text-[clamp(2.5rem,8vw,3.4rem)] font-bold leading-[1.02] tracking-[-0.04em] text-[#0f3d67]">
        ...
        <div className="relative mx-auto w-full max-w-[560px] self-end">
          <div className="relative h-[420px] w-full sm:h-[500px] md:h-[560px] lg:h-[640px] xl:h-[700px]">
            ...
            <div className="absolute -bottom-20 left-1/2 z-10 w-[98%] max-w-[520px] -translate-x-1/2 sm:w-[84%] md:w-[82%] lg:w-[86%]">
              <Image
                src="/Hero-img.png"
            ...
            <div className="absolute -right-10  z-20 flex max-w-[190px] items-center gap-2 rounded-[10px] bg-white px-1 py-2 shadow-[0_10px_35px_rgba(15,45,103,0.12)] sm:right-0 sm:top-14 sm:max-w-[250px] sm:gap-3 sm:px-2 sm:py-1 md:right-[-10px] md:top-16 md:gap-4 md:px-2 md:py-2 lg:right-[-18px] lg:top-20">
